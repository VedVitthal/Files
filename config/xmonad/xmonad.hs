...
myTerminal :: String
myTerminal = "urxvt -e zsh"    -- Sets default terminal
...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
  ...
  where
    spawnTerm  = mySecondTerminal ++ " -t scratchpad"
...
myKeys =
    ...
    -- choose.  Or, type 'SUPER+F2' to set a random wallpaper.
        ...
        , ("M-<F1>", spawn "nitrogen --set-zoom-fill --random")
